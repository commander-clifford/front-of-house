      ...
      <Container maxWidth="xl">
        <Toolbar disableGutters className="header">
          <Link to="/" className="btn btn-secondary">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 6020 1000" style={{width: 'auto', height: '1.5em', fill: 'white', marginLeft: '0.2em', marginRight: '0.2em', paddingBottom: '0.2em'}}>
            <title>HBO Max</title>
            <path
            ...
            />
            <path d="M5895.9,34.85h-28.3v85.2h-20.7V34.85h-28.2V15.05h77.2Z" />
            <path d="M6017.7,120.05h-20.6V52l-29.5,48.7h-2.4l-29.5-48.6V120H5915V15h21.3l30.1,49.6,30-49.6h21.3v105.1Z"
            />
            </svg>
          </Link>
        </Toolbar>
